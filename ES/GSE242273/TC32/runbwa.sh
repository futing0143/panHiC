...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/ES/GSE242273/TC32/bwa-%j.log
#SBATCH -J "TC32"
wkdir=/cluster2/home/futing/Project/panCancer/ES/GSE242273/TC32
cd ${wkdir}
...
sh /cluster2/home/futing/Project/panCancer/ES/sbatch.sh GSE242273 TC32 none "-S merge"
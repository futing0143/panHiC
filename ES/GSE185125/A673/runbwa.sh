...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/ES/GSE185125/A673/bwa-%j.log
#SBATCH -J "A673"
wkdir=/cluster2/home/futing/Project/panCancer/ES/GSE185125/A673
cd ${wkdir}
...
cat srr0830.txt | while read -r srr;do
...
sh /cluster2/home/futing/Project/panCancer/ES/sbatch.sh GSE185125 A673 Arima "-S merge"
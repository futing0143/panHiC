...
vcf=/cluster2/home/futing/Project/HiCQTL/CRC_gvcf/population/snp2.out.vcf

# bcftools annotate --set-id '%CHROM\_%POS\_%REF\_%ALT' ./VCF/snp.out.vcf -o snp.out.annoATCG.vcf

cd /cluster2/home/futing/Project/HiCQTL/merged/CRC53g/genotype
...
# 计算 phenotype 的主成分
plink2 --pfile CRC53hard --pca 10 --out ../covariate/CRCgeno10
# plink2 --bfile CRC --pca 10 --out ../covariate/CRCgeno --small-sample
plink --bfile CRC53hard --pca 5 --out ../covariate/CRCgeno5

...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/AML/debug/parallel_Aug04-%j.log
#SBATCH -J "AML_Prallel"


cancer=AML

readonly WKDIR="/cluster2/home/futing/Project/panCancer/${cancer}"
cd "${WKDIR}" || exit 1
source activate HiC
...
parallel -j "${PARALLEL_JOBS}" --colsep '\t' --progress --eta \
    "parallel_execute {1} {2} {3} '${WKDIR}'" :::: "${WKDIR}/check/check_Aug04.txt"

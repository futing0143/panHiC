...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/HCC/GSE35585/HepG2_ENCLB567NSJ/bwa-%j.log
#SBATCH -J "HepG2_ENCLB567NSJ"

wkdir=/cluster2/home/futing/Project/panCancer/HCC/GSE35585/HepG2_ENCLB567NSJ
cd ${wkdir}
...
sh /cluster2/home/futing/Project/panCancer/HCC/sbatch.sh GSE35585 HepG2_ENCLB567NSJ none "-S merge"

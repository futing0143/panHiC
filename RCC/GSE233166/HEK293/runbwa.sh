...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/RCC/GSE233166/HEK293/bwa-%j.log
#SBATCH -J "HEK293"
wkdir=/cluster2/home/futing/Project/panCancer/RCC/GSE233166/HEK293
cd ${wkdir}
...
# sh /cluster2/home/futing/Project/panCancer/RCC/sbatch.sh GSE233166 HEK293 MboI "-S merge"
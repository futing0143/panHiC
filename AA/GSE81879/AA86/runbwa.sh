...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/AA/GSE81879/AA86/countligation-%j.log
#SBATCH -J "AA_cl"
...
usegzip=1
tmpdir=/cluster2/home/futing/Project/panCancer/AA/GSE81879/AA86/HiC_tmp
# 01
# name=SRR3586203
# name1=${name}_R1
# name2=${name}_R2
...
for name in SRR3586204 SRR3586203;do
	nofrag=0

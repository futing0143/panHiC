...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/AA/GSE81879/AA86/debug/FY1199-%j.log
#SBATCH -J "eagleC"
...
predictSV --hic-5k ${dir}/cool/SKNMC-MboI-allReps-filtered.mcool::/resolutions/5000 \
	--hic-10k ${dir}/cool/SKNMC-MboI-allReps-filtered.mcool::/resolutions/10000  \
	--hic-50k ${dir}/cool/SKNMC-MboI-allReps-filtered.mcool::/resolutions/50000 \
	-O SKNMC -g hg38 --balance-type ICE --output-format NeoLoopFinder \
	--prob-cutoff-5k 0.8 --prob-cutoff-10k 0
<< 'EOF'
...
predictSV --mcool ${dir}/cool/SKNMC-MboI-allReps-filtered.mcool --resolutions 25000,50000,100000 \
			--high-res 25000 --prob-cutoff-1 0.5 --prob-cutoff-2 0.5 -O SKNMC_EagleC2 \
			-g hg38 --balance-type ICE -p 8 --intra-extend-size 1,1,1 --inter-extend-size 1,1,1

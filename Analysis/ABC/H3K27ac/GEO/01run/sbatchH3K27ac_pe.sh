...
submit_job() {
    ...
    # 3. 环境变量与路径定义
    local script="/cluster2/home/futing/pipeline/ChIP_CUTTAG/cut2rose_v6.sh"
...
done < <(sed -n '2,5p' "/cluster2/home/futing/Project/panCancer/Analysis/ABC/H3K27ac/GEO/01run/H3K27ac_pe0128.txt")
# SBATCH --nodelist=node1

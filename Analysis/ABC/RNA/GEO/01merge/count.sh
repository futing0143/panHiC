...
# python /cluster2/home/futing/pipeline/RNA/feature-count-extract.py 6 ${list_csv} >> ./${name}-fpkm-matrix.txt
python /cluster2/home/futing/pipeline/RNA/feature-count-extract.py 5 ${list_csv} >> ./${name}-tpm-matrix.txt
python /cluster2/home/futing/pipeline/RNA/feature-count-extract.py 4 ${list_csv} >> ./${name}-count-matrix.txt

...
# 示例基因列表
genes = read.csv('/cluster2/home/futing/Project/panCancer/Analysis/conserve/PCG_50k800k.txt',header = F)
gene_list <- genes$V1 %>% unique()
...
ego <- enrichGO(gene = entrez_ids$ENTREZID, 
                ...
                qvalueCutoff = 0.1, #0.2
                readable = TRUE)
dotplot(ego)
result <- as.data.frame(ego)
write.table(result,'/cluster2/home/futing/Project/panCancer/Analysis/conserve/PCG_50k800k_strict.txt',sep='\t',row.names =F)
ggsave('/cluster2/home/futing/Project/panCancer/Analysis/conserve/PCG_50k800k_strict.pdf', width=7, height=6)

...
com1 <- prcomp(data_fil, center = T,scale = TRUE)
...
PC1umap=merge(PC1umap,meta[,c(1,4)],by='ncell')
PC1umap
...
write.table(PC1umap,"/cluster2/home/futing/Project/panCancer/Analysis/QC/insul/plot/UMAPinsul337_top1w.txt",sep="\t",row.names = F)
...
puma
ggsave("/cluster2/home/futing/Project/panCancer/Analysis/QC/insul/UMAPinsul327_stop1w.pdf", egg::set_panel_size(puma, width=unit(3, "in"), height=unit(3, "in")),
...
write.table(compare,"/cluster2/home/futing/Project/panCancer/Analysis/QC/insul/plot/compare_insul337_top1w.txt",sep="\t",row.names = F)

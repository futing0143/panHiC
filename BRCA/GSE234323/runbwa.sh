...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/BRCA/GSE234323/MDA-MB-436/bwa-%j.log
#SBATCH -J "MDA-MB-436"

wkdir=/cluster2/home/futing/Project/panCancer/BRCA/GSE234323/MDA-MB-436
cd ${wkdir}
...
sh /cluster2/home/futing/Project/panCancer/BRCA/sbatch.sh GSE234323 MDA-MB-436 MboI "-S merge"
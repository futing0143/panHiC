...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/BRCA/dump-%j.log
#SBATCH -J "dump"
ulimit -s unlimited
ulimit -l unlimited

date
readonly WKDIR="/cluster2/home/futing/Project/panCancer/BRCA"
cd "${WKDIR}" || exit 1
...
parallel -j "${PARALLEL_JOBS}" --colsep '\t' --progress --eta \
    "parallel_execute {1}" :::: "${WKDIR}/dump1015.txt"

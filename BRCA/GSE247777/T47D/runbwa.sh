...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/BRCA/GSE247777/T47D/bwa-%j.log
#SBATCH -J "T47D"
wkdir=/cluster2/home/futing/Project/panCancer/BRCA/GSE247777/T47D
cd ${wkdir}
...
sh /cluster2/home/futing/Project/panCancer/BRCA/sbatch.sh GSE247777 T47D MboI "-S merge"
...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/BRCA/GSE237722/MCF7/bwa-%j.log
#SBATCH -J "MCF7_7722"
wkdir=/cluster2/home/futing/Project/panCancer/BRCA/GSE237722/MCF7
cd ${wkdir}
...
for name in SRR25419780 SRR25419781;do
...
sh /cluster2/home/futing/Project/panCancer/BRCA/sbatch.sh GSE237722 MCF7 none "-S merge"
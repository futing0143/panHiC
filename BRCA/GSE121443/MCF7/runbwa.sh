...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/BRCA/GSE121443/MCF7/bwa-%j.log
#SBATCH -J "MCF7"
wkdir=/cluster2/home/futing/Project/panCancer/BRCA/GSE121443/MCF7
cd ${wkdir}

mkdir -p ./{aligned,fastq,cool,anno,splits,HiC_tmp}
...
ext=".fastq.gz"
ligation="(GTATAC|GTAATG|GTAAG|CATTAC|CATATG|CATTAG|CTATAC|CTAATG|CTATAG)"
site="CCB"
...
sh /cluster2/home/futing/Project/panCancer/BRCA/sbatch.sh GSE121443 MCF7 CCB "-S merge"
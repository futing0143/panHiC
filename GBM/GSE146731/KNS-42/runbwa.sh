...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/GBM/GSE146731/KNS-42/KNS-42-%j.log
#SBATCH -J "KNS-42"

wkdir=/cluster2/home/futing/Project/panCancer/GBM/GSE146731/KNS-42
cd ${wkdir}
...
ln -s ${wkdir}/fastq/SRR11281970* ${wkdir}/splits/

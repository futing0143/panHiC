...
file=/cluster/home/futing/Project/GBM/same0906.txt
echo "比较 $dir1 和 $dir2 ..."
...
grep -v '\.bam$' same0906.txt | grep -v '\.fastq.gz$' > same_del0906.txt
# while read -r file;do
# 	echo "rm -r $file"
# 	rm $file
# done < '/cluster/home/futing/Project/GBM/same_del0906.txt'

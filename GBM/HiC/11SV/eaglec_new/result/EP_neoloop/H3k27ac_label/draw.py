...
def create_visualization(file, cooler_path, assembly, h3k27ac_path, loops_file):
    try:
        ...
        output_folder = "/cluster/home/tmp/GBM/HiC/11SV/eaglec_new/result/EP_neoloop/H3k27ac_label/pic"
        output_file = f"{output_folder}/{file}_{neo}.png"
        vis.outfig(output_file, dpi=300)
    
    except Exception as e:
        # 如果遇到错误，记录文件名和错误信息
        with open("/cluster/home/tmp/GBM/HiC/11SV/eaglec_new/result/EP_neoloop/H3k27ac_label/error_log.txt", "a") as log_file:

...
# cat /cluster/home/futing/Project/GBM/HiC/02data/03cool/info/infolist.txt | while read i; do
#   sum=$(cooler info /cluster/home/futing/Project/GBM/HiC/02data/03cool/10000/${i}_10000.cool | grep -Po '"sum": \K[0-9]+')
#   echo -e "$i\t$sum"
# done

...
chrom_sizes=/cluster/home/futing/ref_genome/hg38.genome
...
if [[ $input_mcool == *.mcool ]]; then
    ...
    java -Xmx400G -jar $juicer_tools_jar pre -r 10000 --threads 20 ${output_bedpe}.short.sorted $output_hic $chrom_sizes
fi

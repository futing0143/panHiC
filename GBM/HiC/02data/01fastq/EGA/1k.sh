...
cat /cluster/home/futing/Project/GBM/HiC/02data/01fastq/EGA/name_undone.txt | while read name;do
    date
    echo -e "Processing $name...\n"
    cd /cluster/home/futing/Project/GBM/HiC/02data/01fastq/EGA/${name}
    outputdir=/cluster/home/futing/Project/GBM/HiC/02data/01fastq/EGA/${name}/aligned
    
    ${juiceDir}/scripts/common/juicer_tools pre -j 20 -r 1000 -s $outputdir/inter_30.txt \

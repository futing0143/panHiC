...
cd /cluster/home/futing/Project/GBM/RNA/pHGG
find /cluster/home/futing/Project/GBM/RNA/pHGG/star_out -name '*_Aligned.toTranscriptome.out.bam' | while read -r file; do
...
sh /cluster/home/futing/Project/GBM/RNA/pHGG/mergeTPM.sh
...
do
	...
	##filtrate data
	trim_galore -q 25 --phred33 --length 50 -e 0.1 --stringency 3 --paired -o ./trim /cluster/home/hjwu/dfci/gbm_data/rnaseq/fastq/${i}_R1.fq.gz /cluster/home/hjwu/dfci/gbm_data/rnaseq/fastq/${i}_R2.fq.gz

...
cd /cluster/home/futing/Project/GBM/RNA/GBM
find /cluster/home/futing/Project/GBM/RNA/GBM/star_out -name '*_Aligned.toTranscriptome.out.bam' | while read -r file; do
...
sh /cluster/home/futing/Project/GBM/RNA/GBM/mergeTPM.sh
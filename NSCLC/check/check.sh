...
# 检查post部分的输出
cancer=NSCLC
output_file=/cluster2/home/futing/Project/panCancer/${cancer}/check/check_July25.txt
>${output_file}
check_file() {
	local file="$1"
	# 检查文件是否存在
...
# IFS=$','
# while read -r gse cell other;do
# 	file=/cluster2/home/futing/Project/panCancer/${cancer}/${gse}/${cell}/anno/stripecaller
# 	if [ -s $file ];then

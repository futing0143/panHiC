...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/DLBCL/GSE35585/OCI-LY7/dump-%j.log
#SBATCH -J "dump"

date
readonly WKDIR="/cluster2/home/futing/Project/panCancer/DLBCL/GSE35585/OCI-LY7"
cd "${WKDIR}" || exit 1
...
parallel -j "${PARALLEL_JOBS}" --colsep '\t' --progress --eta \
    "parallel_execute {1}" :::: "${WKDIR}/srr.txt"

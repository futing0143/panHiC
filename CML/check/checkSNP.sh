#!/bin/bash
cancer=CML
output_file=/cluster2/home/futing/Project/panCancer/${cancer}/check/${cancer}_bam.txt
meta_file=/cluster2/home/futing/Project/panCancer/${cancer}/meta/${cancer}_meta.txt
...
while read -r gse cell other; do
    dir="/cluster2/home/futing/Project/panCancer/${cancer}/${gse}/${cell}/splits"

...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/MTC/GSE237300/thyroid_gland/bwa-%j.log
#SBATCH -J "thyroid_gland"
wkdir=/cluster2/home/futing/Project/panCancer/MTC/GSE237300/thyroid_gland
cd ${wkdir}

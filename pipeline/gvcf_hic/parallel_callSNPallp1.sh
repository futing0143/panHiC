...
# cat /cluster2/home/futing/Project/HiCQTL/cell_all.txt | while read -r cell;do
cat /cluster2/home/futing/Project/HiCQTL/pipeline/gvcf_hic/missing_bam0917.txt | while read -r cell;do

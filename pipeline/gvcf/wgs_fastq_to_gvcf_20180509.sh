...
#reference
# reference=/cluster/home/futing/ref_genome/hg38_gencode/bowtie2_25chr/hg38_25chr.fa
...
# $gatk IndexFeatureFile -I $GATK_bundle/hapmap_3.3.hg38.vcf
# $gatk IndexFeatureFile -I $GATK_bundle/1000G_omni2.5.hg38.vcf
# $gatk IndexFeatureFile -I $GATK_bundle/1000G_phase1.snps.high_confidence.hg38.vcf
# $gatk IndexFeatureFile -I $GATK_bundle/Mills_and_1000G_gold_standard.indels.hg38.vcf
# $gatk IndexFeatureFile -I $GATK_bundle/dbsnp138.hg38.vcf #146
...
# if [[ ! -f $outdir/cleanfq/${fq_file_name}.paired.1.fq.gz ]];then
# 	time ${trimmomatic} PE \
# 		$fq1 $fq2 \
...
# fi
 	# /cluster/home/futing/miniforge-pypy3/envs/HiC/share/trimmomatic/adapters/TruSeq2-PE.fa:2:30:10:8:True \

pacman::p_load(readxl,ggplot2,egg,reshape2,RColorBrewer,harrypotter,ochRe,dutchmasters,dplyr,stringr)
setwd('/cluster2/home/futing/Project/panCancer/QC/')



# ------ s计算高置信度的loop数目
count<- read.table('/cluster2/home/futing/Project/panCancer/QC/hicInfo_jun29.txt',header=T)
...
gradient_colors <- colorRampPalette(set1)(12) #%>% rev()
plot(1:12, rep(1, 12), col = gradient_colors, pch = 19, cex = 5)
p<-
...
ggsave("nContacts_Jun29can.pdf", egg::set_panel_size(p, width=unit(8, "in"), height=unit(3, "in")), 

...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/CRC/GSE207951/CRC25988/debug/bwa-%j.log
#SBATCH -J "CRC25988"
wkdir=/cluster2/home/futing/Project/panCancer/CRC/GSE207951/CRC25988
cd ${wkdir}
...
sh /cluster2/home/futing/Project/panCancer/CRC/sbatch.sh GSE207951 CRC25988 mHiC "-S merge"
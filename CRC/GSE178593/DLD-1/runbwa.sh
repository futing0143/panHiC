...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/CRC/GSE178593/DLD-1/bwa-%j.log
#SBATCH -J "DLD-1"
wkdir=/cluster2/home/futing/Project/panCancer/CRC/GSE178593/DLD-1
cd ${wkdir}
...
sh /cluster2/home/futing/Project/panCancer/CRC/sbatch.sh GSE178593 DLD-1 Arima "-S merge"
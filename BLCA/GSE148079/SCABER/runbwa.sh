...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/BLCA/GSE148079/SCABER/bwa-%j.log
#SBATCH -J "SCABER"

wkdir=/cluster2/home/futing/Project/panCancer/BLCA/GSE148079/SCABER
cd ${wkdir}
...
sh /cluster2/home/futing/Project/panCancer/BLCA/sbatch.sh GSE148079 SCABER Arima "-S merge"
...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/BLCA/GSE148079/SW780/bwa-%j.log
#SBATCH -J "SW780"

wkdir=/cluster2/home/futing/Project/panCancer/BLCA/GSE148079/SW780
cd ${wkdir}
...
sh /cluster2/home/futing/Project/panCancer/BLCA/sbatch.sh GSE148079 SW780 Arima "-S merge"
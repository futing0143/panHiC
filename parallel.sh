...
parallel_execute() {
    ...
    sh "/cluster2/home/futing/Project/HiCQTL/hicQTL_single.sh" \
       "/cluster2/home/futing/Project/panCancer/CRC/${gse}/${cell}/splits" \
       "${enzyme}" >> "$log_file" 2>&1
...
parallel -j $PARALLEL_JOBS --colsep ' ' --progress --eta \
  "parallel_execute {1} {2} {3}" :::: "/cluster2/home/futing/Project/HiCQTL/snpundone.txt"
...
# awk -F ',' '{print "GSE137188",$0,"MboI"}' snpall.txt > tmp && mv tmp snpall.txt

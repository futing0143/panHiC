...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/NUT/GSE133163/293TRex/bwa-%j.log
#SBATCH -J "293TRex"

wkdir=/cluster2/home/futing/Project/panCancer/NUT/GSE133163/293TRex
cd ${wkdir}

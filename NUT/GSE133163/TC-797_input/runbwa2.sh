...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/NUT/GSE133163/TC-797_input/bwa-%j.log
#SBATCH -J "TC-797_input"
wkdir=/cluster2/home/futing/Project/panCancer/NUT/GSE133163/TC-797_input
cd ${wkdir}
...
sh /cluster2/home/futing/Project/panCancer/NUT/sbatch.sh GSE133163 TC-797_input none "-S merge"
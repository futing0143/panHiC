...
#SBATCH --output=/cluster2/home/futing/Project/panCancer/ALL/GSE145997/ALL_PDX40/bwa-%j.log
#SBATCH -J "ALL_PDX40"

wkdir=/cluster2/home/futing/Project/panCancer/ALL/GSE145997/ALL_PDX40
cd ${wkdir}
...
sh /cluster2/home/futing/Project/panCancer/ALL/sbatch.sh GSE145997 ALL_PDX40 Arima "-S merge"